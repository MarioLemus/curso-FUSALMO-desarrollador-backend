...
const app = express();
const port = 3000;
const accessToken = 'pk.eyJ1IjoiY29uZmV0aWNsaSIsImEiOiJjbHd0bnl4am0wNjV1MnFwb3llYWtxOWc3In0.0QaEME-AK9cumnkBVF5V9w';
...
app.post('/add-store', async (req, res) => {
    const { address, placeName, review } = req.body;
